        ...
        <header className="flex h-16 items-center justify-between border-b border-neutral-200 bg-white px-4 sm:px-8">
            ...
            <div className="flex items-center gap-2 sm:gap-4">
                ...
                <div className="relative">
                    ...
                    {menuOpen && (
                        <div className="absolute right-0 mt-2 w-48 animate-fade-in rounded-lg border border-neutral-200 bg-white py-1.5 shadow-lg">
                            ...
                            <button
                                ...
                                className="flex w-full items-center gap-2 px-3.5 py-2 text-sm font-medium text-danger-600 transition-colors hover:bg-danger-50"
                            >
